...
public class stat {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_LONG_LONG$LAYOUT.withName("st_atime"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("st_atimensec"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("st_mtime"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("st_mtimensec"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("st_ctime"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("st_ctimensec"),
    ...
    static final VarHandle st_atime$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("st_atime"));
    public static VarHandle st_atime$VH() {
        return stat.st_atime$VH;
    }
    public static long st_atime$get(MemorySegment seg) {
        return (long)stat.st_atime$VH.get(seg);
    }
    public static void st_atime$set( MemorySegment seg, long x) {
        stat.st_atime$VH.set(seg, x);
    }
    public static long st_atime$get(MemorySegment seg, long index) {
        return (long)stat.st_atime$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void st_atime$set(MemorySegment seg, long index, long x) {
        stat.st_atime$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle st_atimensec$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("st_atimensec"));
    public static VarHandle st_atimensec$VH() {
        return stat.st_atimensec$VH;
    }
    public static long st_atimensec$get(MemorySegment seg) {
        return (long)stat.st_atimensec$VH.get(seg);
    }
    public static void st_atimensec$set( MemorySegment seg, long x) {
        stat.st_atimensec$VH.set(seg, x);
    }
    public static long st_atimensec$get(MemorySegment seg, long index) {
        return (long)stat.st_atimensec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void st_atimensec$set(MemorySegment seg, long index, long x) {
        stat.st_atimensec$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle st_mtime$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("st_mtime"));
    public static VarHandle st_mtime$VH() {
        return stat.st_mtime$VH;
    }
    public static long st_mtime$get(MemorySegment seg) {
        return (long)stat.st_mtime$VH.get(seg);
    }
    public static void st_mtime$set( MemorySegment seg, long x) {
        stat.st_mtime$VH.set(seg, x);
    }
    public static long st_mtime$get(MemorySegment seg, long index) {
        return (long)stat.st_mtime$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void st_mtime$set(MemorySegment seg, long index, long x) {
        stat.st_mtime$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle st_mtimensec$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("st_mtimensec"));
    public static VarHandle st_mtimensec$VH() {
        return stat.st_mtimensec$VH;
    }
    public static long st_mtimensec$get(MemorySegment seg) {
        return (long)stat.st_mtimensec$VH.get(seg);
    }
    public static void st_mtimensec$set( MemorySegment seg, long x) {
        stat.st_mtimensec$VH.set(seg, x);
    }
    public static long st_mtimensec$get(MemorySegment seg, long index) {
        return (long)stat.st_mtimensec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void st_mtimensec$set(MemorySegment seg, long index, long x) {
        stat.st_mtimensec$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle st_ctime$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("st_ctime"));
    public static VarHandle st_ctime$VH() {
        return stat.st_ctime$VH;
    }
    public static long st_ctime$get(MemorySegment seg) {
        return (long)stat.st_ctime$VH.get(seg);
    }
    public static void st_ctime$set( MemorySegment seg, long x) {
        stat.st_ctime$VH.set(seg, x);
    }
    public static long st_ctime$get(MemorySegment seg, long index) {
        return (long)stat.st_ctime$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void st_ctime$set(MemorySegment seg, long index, long x) {
        stat.st_ctime$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle st_ctimensec$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("st_ctimensec"));
    public static VarHandle st_ctimensec$VH() {
        return stat.st_ctimensec$VH;
    }
    public static long st_ctimensec$get(MemorySegment seg) {
        return (long)stat.st_ctimensec$VH.get(seg);
    }
    public static void st_ctimensec$set( MemorySegment seg, long x) {
        stat.st_ctimensec$VH.set(seg, x);
    }
    public static long st_ctimensec$get(MemorySegment seg, long index) {
        return (long)stat.st_ctimensec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void st_ctimensec$set(MemorySegment seg, long index, long x) {
        stat.st_ctimensec$VH.set(seg.asSlice(index*sizeof()), x);
    }
