...
public class mcontext_t {
    ...
    public static MemorySegment __fpregs$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment) mcontext_t.__fpregs$VH.get(seg);
    }

    public static void __fpregs$set(MemorySegment seg, MemorySegment x) {
        mcontext_t.__fpregs$VH.set(seg, x);
    }

    public static MemorySegment __fpregs$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment) mcontext_t.__fpregs$VH.get(seg.asSlice(index * sizeof()));
    }

    public static void __fpregs$set(MemorySegment seg, long index, MemorySegment x) {
