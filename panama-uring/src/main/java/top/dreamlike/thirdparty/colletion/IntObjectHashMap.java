...
package top.dreamlike.thirdparty.colletion;
...
public class IntObjectHashMap<V> implements IntObjectMap<V>, Iterable<IntObjectMap.Entry<V>> {
    ...
    public void putAll(IntObjectMap<V> sourceMap) {
        if (sourceMap instanceof IntObjectHashMap<V> source) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof @SuppressWarnings("rawtypes")IntObjectMap other)) {
            return false;
        }
        if (size != other.size()) {
            return false;
