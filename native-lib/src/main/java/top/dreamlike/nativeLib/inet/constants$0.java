...
class constants$0 {
    ...
    static final FunctionDescriptor __bswap_16$FUNC = FunctionDescriptor.of(CType.C_SHORT$LAYOUT,
    ...
    static final FunctionDescriptor __bswap_32$FUNC = FunctionDescriptor.of(CType.C_INT$LAYOUT,
        CType.C_INT$LAYOUT
    );
    ...
    static final FunctionDescriptor __bswap_64$FUNC = FunctionDescriptor.of(CType.C_LONG_LONG$LAYOUT,
    ...
    static final FunctionDescriptor __uint16_identity$FUNC = FunctionDescriptor.of(CType.C_SHORT$LAYOUT,
        CType.C_SHORT$LAYOUT
    );
    ...
    static final FunctionDescriptor __uint32_identity$FUNC = FunctionDescriptor.of(CType.C_INT$LAYOUT,
        CType.C_INT$LAYOUT
    );
    ...
    static final FunctionDescriptor __uint64_identity$FUNC = FunctionDescriptor.of(CType.C_LONG_LONG$LAYOUT,
        CType.C_LONG_LONG$LAYOUT
    );
