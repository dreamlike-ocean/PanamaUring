...
extern int io_uring_opcode_supported_ring(const struct io_uring *ring, int op);
 ...
 */
extern void io_uring_cq_advance(struct io_uring *ring,
				       unsigned nr);
 ...
 */
extern void io_uring_cqe_seen(struct io_uring *ring,
...
extern void io_uring_prep_rw(int op, struct io_uring_sqe *sqe, int fd,
 ...
 * failure.
 */
extern int io_uring_wait_cqe_nr(struct io_uring *ring,
